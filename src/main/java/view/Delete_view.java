...
public class Delete_view {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_view window = new Delete_view();
	...
	private void initialize() {
		...
		delete.setBounds(381, 402, 212, 33);
		panel_2.add(delete);
		...
		lblNewLabel_1.setIcon(new ImageIcon(Delete_view.class.getResource("/icon/user1.png")));
...
//				JOptionPane.showConfirmDialog (delete, "Want to delete this employee");
